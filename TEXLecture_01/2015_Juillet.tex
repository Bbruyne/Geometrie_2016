...
\begin{document}  
    ...
    \frame{
	  ...
	  \end{tcolorbox}
	   ...
	   .3 Egalité de longueurs et présence de triangles..
 ...
 \frame{ % résolution ex1
	  \begin{columns}[t]
	   ...
	   .3 Appliquer l'élément de théorie..
	   }
	   }
  ...
  \frame{%Résolution
	...
	.4 Cas général = equation normale d'une droite.
  ...
  \frame{ 
	...
	.5 Eliminer le paramètre.
	.6 Isoler le paramètre dans une equation..

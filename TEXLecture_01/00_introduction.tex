...
\begin{document}  
    ...
    \begin{columns}[t]
      ...
      \vspace{0pt}
      \begin{figure}
      \includegraphics[page=2,scale=0.35]{2015_Septembre.pdf} \\
      \includegraphics[page=3,scale=0.35]{2015_Septembre.pdf}
      ...
      \vspace{-1mm}
      \begin{figure}
      \includegraphics[page=2,scale=0.35]{../TEXLecture_03/Analytique_plan/2002_Juillet_Q2.pdf} \\
      \includegraphics[page=4,scale=0.35]{../TEXLecture_03/Analytique_plan/2002_Juillet_Q2.pdf}
    ...
    \frame{
	   ...
	   .1 Liens.
	   .2 Théorie.
	   .3 A consulter pour se rafraichir l'esprit..

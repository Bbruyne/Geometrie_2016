...
\begin{document}  
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
		...
		\begin{align*}
		 ...
		 = \ & \vect{BA}\cdot(\vect{BC} + \vect{CF}) + \vect{CA}\cdot(\vect{CE}+\vect{EB}), \text{ (\textcolor{blue}{1} et \textcolor{blue}{2})} \\
    ...
    \notedir{%
	   ...
	   .4 Décomposition de $\vect{BF}$ et $\vect{CE}$  pour faire apparaître $\vect{BC}$.. 

...
\begin{document}  
   ...
   \notedir{%
	   .1 Prouver thèse.
	   .2 $|\vect{AD}|^2 + |\vect{AD'}|^2$ \\ \smallskip$= |\vect{AB}|^2 + |\vect{AC}|^2 + |\vect{BC}|^2$.
	   ...
	   .4 Décomposition des vecteurs pour faire apparaître $AB$ et $AC$.
   ...
   \notedir{%
	   ...
	   .3 $\Delta$ equilatéral $\rightarrow$ $|DB|=|CD|=BC|$..
	   .3 Thèse vérifiée..
	   }
    }

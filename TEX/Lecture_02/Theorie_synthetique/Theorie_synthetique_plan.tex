...
\frame{ \frametitle{Triangles.}
	...
	\begin{figure}
				  ...
				  Le carré d'un côté est égal à la somme des carrés des deux autres côtés diminué du double produit de ces deux côtés multiplié par le cosinus de l'angle qu'ils forment. \\ \medskip
	\underline{Médiane issue de l'angle droit d'un triangle rectangle.} \\
				  ...
				  \end{figure}
				  $$|AM| = |BM| $$
				  La médiane issue de l'angle droit d'un $\Delta$ rectangle vaut la moitié de l'hypoténuse.
...
\frame{ \frametitle{Triangles.}
	...
	\begin{figure}
				 ...
				 Les rapports de la longueur d'un côté sur le sinus de l'angle opposé sont égaux.
		\notedir{%
		.1 Relations de longueurs.
		.2 Pythagore généralisé..
		.3 Formule valable pour n'importe quel côté.~Pas seulement pour le côté le plus long..

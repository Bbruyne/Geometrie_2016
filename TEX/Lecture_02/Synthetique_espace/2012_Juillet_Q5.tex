...
\tcbset{%
	basic/.style={colframe=black,
		      ...
		      boxsep=0mm
                     ...
                     \def\enonce{   \frametitle{Q1 Juillet 2012.}
...
\begin{document}  
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
		...
		\textit{Cas général :} \\ \smallskip
                 \heart Trois droites de directions différentes et sécantes 2 à 2 sont concourantes (à prouver). \smallskip
		
		$$\begin{cases}
		 B'C'\parallel BC, (\textcolor{blue}{1.})\\
		 BC\parallel QR.\ (\text{Thalès})
               \end{cases} \rightarrow B'C'\parallel QR.$$ 
               
               $\rightarrow$ $B',C',R,Q$ sont dans un plan.\\ \smallskip
                \heart 2 droites sont $\nmid$ si elles $\in$ au même plan et ne sont pas $\parallel. \rightarrow B'Q \nmid C'R$. \\ \medskip
       ...
       \frame{ 
		...
		Preuve : \begin{numcases}{}X= B'Q \cap C'R, \label{eq:1}\\
...
\smallskip
	   ...
	   .3 De la même façon, $A'P\nmid C'R$ et $A'P\nmid B'Q$..
	   .4 Les trois droites sont 2 à 2 sécantes..

...
\begin{document}  
    ...
    \begin{columns}[t]
      ...
      \vspace{0pt}
      \begin{figure}
      \includegraphics[page=2,scale=0.35]{/home/bbruyne/Documents/Geometrie/PDF/Lecture_01/sans_notes/Recents/2015_Septembre.pdf} \\
      \includegraphics[page=3,scale=0.35]{/home/bbruyne/Documents/Geometrie/PDF/Lecture_01/sans_notes/Recents/2015_Septembre.pdf}
      ...
      \vspace{-1mm}
      \begin{figure}
      \includegraphics[page=2,scale=0.35]{/home/bbruyne/Documents/Geometrie/PDF/Lecture_03/sans_notes/Analytique_plan/2002_Juillet_Q2.pdf} \\
      \includegraphics[page=4,scale=0.35]{/home/bbruyne/Documents/Geometrie/PDF/Lecture_03/sans_notes/Analytique_plan/2002_Juillet_Q2.pdf}
    ...
    \frame{
	   ...
	   \end{enumerate} 	
	   \vfill \bigskip
	   Version 2016 des slides disponible sur : \\ \bigskip \centering \url{https://docs.google.com/uc?export=download&id=0B4e04CXfLA5SQkVzNURWcUktZHc}
	   \notedir{%
	   .1 Liens.
	   .2 Théorie.

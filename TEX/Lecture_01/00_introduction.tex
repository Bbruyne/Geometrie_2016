...
\begin{document}  
    ...
    \frame{\frametitle{Agenda.}
	  ...
	  \rowfont{\scriptsize}%
	  \parbox[t]{1cm}{\textmd{Lundi}} & \textsl{8.45 - 12.15} & \parbox[t]{2.5cm}{Questions récentes;\\ Vectorielle.} & \parbox[t]{2.3cm}{\textit{16J1, 16J2, 17J1,
														 17J2; 01S3, 02S3,
														 03J3, 04J3, 04S3,
														 demo, bary, eule.}\\}
    ...
    \frame{
	   ...
	   \url{https://drive.google.com/drive/folders/0B4e04CXfLA5SRDIzdDA2U0duNEk}
	   \notedir{%
	   .1 Liens.
	   .2 Théorie.

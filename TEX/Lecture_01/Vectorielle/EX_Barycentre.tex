...
\begin{document}  
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
	   ...
	   .3 Résolution..
	   .4 $\vect{MG}$ en fonction de $\vect{MA},\vect{MB},\vect{MC}$..
	   .4 $\vect{MM_1},\vect{MM_2},\vect{MM_3}$ en fonction de $\vect{MA},\vect{MB},\vect{MC}$..
	   .5 $\vect{MK}$ en fonction de $\vect{MA},\vect{MB},\vect{MC}$..
	   .6 $\vect{MK}=2\vect{MG}$..
	   }
    }
	  ...
	  \begin{columns}[t]
		...
		\begin{align*}
		 ...
		 \frac{1}{2}\vect{MC} + \frac{1}{2}\vect{MM_3} = \ & \frac{1}{2}\vect{MA} + \frac{1}{2}\vect{MB} + \frac{1}{2}\vect{MC} \\[1.5em]

...
\begin{document}  
    ...
    \notedir{%
	  ...
	  \underline{Résumé}\\ \flushleft
          \begin{itemize}
	  \item Montrer qu'une expression vectorielle est indépendante d'un point = décomposer vecteurs pour n'en avoir plus qu'un qui contient ce point (le coefficient devant celui-ci devrait s'annuler).

	  ...
	  \begin{columns}[t]
		...
		$\dfrac{|AI|}{|AC|}=\dfrac{|BI|}{|BD|}\quad$ par Thalès (\textcolor{blue}{1.}). \\[1em]
                ...
                \begin{align*}
                  ...
                  &= |AI|^2 + |DI|^2 + |DI|^2 + |CI|^2 + |BI|^2\\&\hspace{20mm} + |AI|^2 + |BI|^2,\\[0.5em]
                  &= 4|AI|^2 + 4|DI|^2 =4|AD|^2.  \hspace{5mm} \qed(b)
                  \end{align*}
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
		...
		\underline{Résolution} \flushleft
                  \begin{align*}
                   ...
                   &\ = \dfrac{1}{2}(-|\vect{IA}||\vect{IC}|+ |\vect{ID}||\vect{BI}|),\\[0.5em]
                   &\ = \dfrac{1}{2}(-|\vect{IA}||\vect{IC}|+ |\vect{IC}||\vect{IA}|), \textcolor{blue}{(2., a).)}\\[0.5em]
	  ...
	  \item Montrer une égalité de longueur lorsqu'il y a des côtés $\parallel$ $\rightarrow$ Thalès ?
          \item Une somme de carrés de longeur $\rightarrow$ Pythagore ?
            \item Si $\vect{AB}\cdot\vect{CD}=0$ alors $AB\bot \vect{CD},$

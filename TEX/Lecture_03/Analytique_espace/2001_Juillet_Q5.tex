...
\tikzset{
  ...
  \def\enonce{ \frametitle{Q5 Juillet 2001.}
...
\begin{document}  
	...
	.6 1\iere\ ligne : $x - D_{1_x}$,$y - D_{1_y}$, $z - D_{1_z}$..
	.6 2\ieme\ ligne : coordonnée de $\vect{d_1}$..
	.6 3\ieme\ ligne : coordonnée de $\vect{d_3}$..	
	.3 Équation de $\beta$.
	.4 $\beta$ est déterminé par un point et 2 vecteurs direct..
	.5 Son équation s'obtient en annulant le déterminant:.
	.6 1\iere\ ligne : $x - D_{2_x}$,$y - D_{2_y}$, $z - D_{2_z}$..
	.6 2\ieme\ ligne : coordonnée de $\vect{d_2}$..
	.6 3\ieme\ ligne : coordonnée de $\vect{d_3}$..	
	}
    }
	\frame{ 			
	...
	.4 $d$ est intersection de $\alpha$ et $\beta$..
	  ...
	  \underline{Résumé}\\ \flushleft
          \begin{itemize}
          \item Pour trouver équation d'un plan, trouver un point et deux vecteurs directeurs du plan,
            \item Utiliser les résultats déjà démontrés.
          \end{itemize}
    }

...
\def\enonce{	\frametitle{Q2 Septembre 2015.}
	 ...
	 équations cartésiennes de $\mathcal{P}_1$ et $\mathcal{P}_2$.
  }
\begin{document}  
  ...
  \frame{ %résolution ex2
	\begin{columns}[t]
		...
		\underline{Résolution}\\
                ...
                \begin{align*}
                  \mathcal{P}\equiv&\ y = p(x-x_s)^2 + y_s\\
\mathcal{P}_1\equiv& \begin{cases} p_1>0 \\ (x_{s_1},y_{s_1})=(0,0)\end{cases}\\\rightarrow \mathcal{P}_1\equiv&\ y=px^2.\\\mathcal{P}_2\equiv& \begin{cases} p_2=p_1 \\ (x_{s_2},y_{s_2})=(4,0)\end{cases}\\\rightarrow \mathcal{P}_2\equiv&\ y=p(x-4)^2.
                \end{align*}
                
	 $X = \mathcal{P}_1 \cap \mathcal{P}_2 = (2,4p)$.\medskip
		
         \heart Deux droites sont $\bot$ si le produit de leur coefficient angulaire vaut $-1$.\vspace{-1mm}
         \begin{align*}
	...
	\begin{columns}[t]
		...
		\underline{Résolution}\\
         ...
         \begin{align*}
		p=& \text{ }\dfrac{1}{4} \quad \text{ car } p>0.  
		\end{align*}
                
		$\rightarrow \begin{cases}\mathcal{P}_1\equiv y=\frac{x^2}{4}, \\

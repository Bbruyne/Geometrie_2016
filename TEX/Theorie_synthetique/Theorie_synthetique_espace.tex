  ...
  .2 Implication : droite orthogonale à tt droites du plan..
    ...
    \begin{columns}[t]
     \column{.3333\textwidth}
				  ...
				  \end{tikzpicture}
				  \end{figure}
				  \textit{Sécantes} : coplanaires et non paralèlles.
     \column{.34\textwidth}
				  \begin{figure}[h]
				  \begin{tikzpicture}[scale=0.85]
			          %projection ($(X)!(B')!(B)$)
				  ...
				  \end{tikzpicture}
				  \end{figure}
				  \textit{Paralèlles} : coplanaires et angles correspondants  égaux.
	\column{.3333\textwidth}
				  \begin{figure}[h]
				  \begin{tikzpicture}[scale=0.85]
			          %projection ($(X)!(B')!(B)$)
				  ...
				  \textit{Gauches} : ni paralèlles ni sécantes.			  
    \end{columns}

	\notedir{%
	.1 Positions des droites.
	.2 Sécantes si coplanaires et non paralèlles..
	.2 Paralèlles si coplanaires et angles correspondants égaux..
	.2 Gauches si ni sécantes ni paralèlles..
	} 
    }

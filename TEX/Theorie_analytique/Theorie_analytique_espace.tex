    ...
    \begin{columns}[t]
	  ...
	  \begin{align*}
	   \pi \equiv& P + \lambda \vect{u_1} + \mu \vect{u_2} , \quad (\lambda,\mu \in \mathbb{R}) \\
	     \equiv& \begin{cases}
	              x = P_x + \lambda u_{1_x} + \lambda u_{2_x}, \\
	              y = P_y + \lambda u_{1_y} + \lambda u_{2_y}, \\
	              z = P_z + \lambda u_{1_z} + \lambda u_{2_z}. \\
	             \end{cases} 
	  \end{align*} 
	  \medskip
	  
	  On fait varier le paramètre, on obtient les points du plan. \\ \medskip

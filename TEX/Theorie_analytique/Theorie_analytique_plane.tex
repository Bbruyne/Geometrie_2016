...
\begin{document}  
    ...
    \frame{
	  ...
	  \frametitle{Equations d'éléments 2D.}
	  \begin{columns}[b]
	   \column{.29\textwidth}\centering \underline{Parabole.}
				  ...
				  \end{tikzpicture}
				  \end{figure}
				    $$\mathcal{P} \equiv y = a(x - x_s)^2 + y_s.$$ \smallskip
	   ...
	   \begin{figure}[h]
				  ...
				  \end{tikzpicture}
				  \end{figure}
				    $\mathcal{E} \equiv \frac{(x-x_s)^2}{a} + \frac{(y-y_s)^2}{b} = 1$. \medskip \vspace{1mm}
	...
	\notedir{%
	.1 Equations d'éléments 2D à connaitres.
	.2 Parabole..
	.3 $(x_s,y_s)$ sommet..
	.3 $a$ courbure..

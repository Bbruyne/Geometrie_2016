...
\begin{document}  
    ...
    \frame{ 
	  % résolution ex1
		...
		De $(\dagger)$, si $\alpha \in \mathbb{R}$, $y\ge0$.\\ \medskip
		Lieu est demi-droite $d$ comprise dans région $y\ge0$. \hfill $\qed(b)$
	...
	.4 Equations paramétriques vers cartésiennes.	

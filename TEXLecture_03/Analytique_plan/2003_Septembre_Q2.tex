...
\begin{document}  
    ...
    \frame{ 
	  % résolution ex1
		...
		\heart Equation ellipse : $\frac{x^2}{a^2}+\frac{y^2}{b^2}=1$. \\ \medskip
		 ...
		 $m(x_p) = \dfrac{b\ x_p}{a\sqrt{a^2-x_p^2}}$.\\ \medskip
		 $t \equiv \begin{cases}
		            \ni P, \\
		            m(x_p).
	...
	.2 Résolution.
	.3 Poser un repère.
	.4 Equation de l'ellipse $\frac{x^2}{a^2}+\frac{y^2}{b^2}=1$..
	.4 Coordonnées de $A_1,A_2$.
	.4 Coordonnée de $P$.
	.5 $P$ est dans partie supérieure de ellispe sans perte de généralité car symétrie..
	.5 $x_p$ varie de $[-a,a]$..
	.3 Equation de tangente $t$.
	.4 Pente est la dérivée de l'équation de l'ellipse en $x_p$..
	.4 Equation obtenue avec pente et point $P$..

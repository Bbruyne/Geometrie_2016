...
\begin{document}  
    ...
    \frame{
	  ...
	  $y = x^2$ et $P$ le point de $\mathcal{P}$ d’abcisse $1$. Quel est le lieu des sommets des paraboles
	  ...
	  \pause
	   ...
	   \begin{tcolorbox}[basic] \smallskip
		      ...
		      Equation des sommets de $\mathcal{P_L}$ avec les conditions : \\ \medskip 
		      \begin{columns}
	...
	.3 Eliminer paramètre $a$ pour avoir équation des sommets.

...
\begin{document}  
	  ...
	  \begin{tcolorbox}[basic] 
		 ...
		 \column{.5\textwidth}\centering
		  ...
		  \column{.5\textwidth}\centering
		      ...
		      \end{enumerate}
		      {\small $A',B',C',D'$ pieds des hauteurs.} 
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
		...
		$CD\bot EA,CD\bot EB\rightarrow CD\bot ABE$.$\qed$
    ...
    \frame{ 
	  ...
	  \begin{columns}[t]
		...
		\textcolor{blue}{$\heartsuit_2$} Des $\Delta$ sont isométriques s'ils ont un angle de même mesure entre 2 cotés de mêmes longueurs. \\ \medskip
		$BAA',CAA',DAA'$ isométriques. \\
		\begin{align*}
		A'=& \text{ centre cercle circonscrit,} \\
		  =& \text{ orthocentre. (\textcolor{blue}{$\heartsuit_1$})} 
		\end{align*}
		\begin{enumerate}
		 \item Propriété montrée pour un sommet est vraie pour tous les autres grâce à la symétrie. \hfill $\qed$
		\end{enumerate}
		\centering\noindent\rule{2cm}{0.4pt}	
   ...
   \frame{ 
	  ...
	  \begin{columns}[t]
		...
		\column{.5\textwidth}\flushleft
		$AA',BB',CC'$ sont concourantes. \\ \medskip
		De la même façon : \\ \medskip
		$AA',BB',DD'$ sont concourantes. \\ \bigskip
